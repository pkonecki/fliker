...
else
{
	...
	print 	"<form method='POST' action='index.php?page=16'>
			<b>Statut est </b><select name='statut_demande'><option value='all'>Indifférent</option><option ".($statut_demande == "pending" ? "selected" : "")." value='pending'>En attente</option><option ".($statut_demande == "accepted" ? "selected" : "")." value='accepted'>Accepté</option><option ".($statut_demande == "refused" ? "selected" : "")." value='refused'>Refusé</option></select><br/>
			<b>Etape est </b><select name='etape_demande'><option value='all'>Indifférent</option><option ".($etape_demande == "ask" ? "selected" : "")." value='ask'>Demandé</option><option ".($etape_demande == "authorized" ? "selected" : "")." value='authorized'>Autorisé</option><option ".($etape_demande == "over" ? "selected" : "")." value='over'>Terminé</option></select><br/>
