...
class EspaceMembre
{
	...
	public function showMenu($page = 0)
	{
		...
		{
			if ($page == 1)
				print '<ul id="submenu"><li><a href="index.php?page=7&adh='.(isset($_GET['adh']) ? $_GET['adh'] : $_SESSION['uid']).'">Adhésions</a></li><li><a class="selected" href="index.php?page=1&adh='.(isset($_GET['adh']) ? $_GET['adh'] : $_SESSION['uid']).'">Adhérent</a></li></ul>';
			else if ($page == 7)
				print '<ul id="submenu"><li><a class="selected" href="index.php?page=7&adh='.(isset($_GET['adh']) ? $_GET['adh'] : $_SESSION['uid']).'">Adhésions</a></li><li><a href="index.php?page=1&adh='.(isset($_GET['adh']) ? $_GET['adh'] : $_SESSION['uid']).'">Adhérent</a></li></ul>';
			else if ($page == 9)
				print '<ul id="submenu"><li><a class="selected" href="index.php?page=9">Général</a></li><li><a href="index.php?page=11">Notifications</a></li><li><a href="index.php?page=13">Messages</a></li><a href="index.php?page=19">Champs</a></ul>';
			else if ($page == 11)
				print '<ul id="submenu"><li><a href="index.php?page=9">Général</a></li><li><a class="selected" href="index.php?page=11">Notifications</a></li><li><a href="index.php?page=13">Messages</a></li><a href="index.php?page=19">Champs</a></ul>';
			else if ($page == 13)
